...
export default {
    ...
    async created() {
        ...
        this.receitasEncontradas = receitas.filter((receita) => {
            ...
            // todos os ingredientes de uma receita devem esta inclusos na minha lista de ingredientes
            //se sim, devemos returnar 'true'
...
<template>
    ...
    <section class="mostrar-receitas">
        ...
        <p class="paragrafo-lg resultados-encontrados">
            Resultado encontrados {{ receitasEncontradas.length }}
        </p>


        <div v-if="receitasEncontradas.length" class="receitas-wrapper">
            <p class="paragrafo-lg inforacoes">
